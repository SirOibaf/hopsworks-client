...
class Locale(object):
    ...
    def __init__(self, language=None, script=None, country=None, variant=None, extension_keys=None, unicode_locale_attributes=None, unicode_locale_keys=None, iso3_language=None, iso3_country=None, display_language=None, display_script=None, display_country=None, display_variant=None, display_name=None):  # noqa: E501
