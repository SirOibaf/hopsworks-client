 ...
 */import { HistogramBinDTO } from './histogramBinDTO';


export interface FeatureDistributionDTO { 
    featureName?: string;
    frequencyDistribution?: Array<HistogramBinDTO>;
    statisticType?: FeatureDistributionDTO.StatisticTypeEnum;
}
export namespace FeatureDistributionDTO {
